const translations = {
    es: {
        ...
        'nextsteps-download-title': 'Descargar Resultados',
        'nextsteps-download-desc': 'Guarda tus resultados y compártelos con amigos y familiares.',
        'btn-download-results': 'Descargar Resultados',
        'nextsteps-catalogue-title': 'Ver Catálogo de Equipos',
        'nextsteps-catalogue-desc': 'Conoce más sobre los sistemas de transporte solar de Kara Solar: cómo funciona, especificaciones técnicas y servicios postventa.',
        'btn-view-catalogue': 'Ver Catálogo',
        'nextsteps-contact-title': 'Compras y Consultas',
        'nextsteps-contact-desc': '¿Listo para hacer la transición al transporte fluvial solar? Ya sea que tengas preguntas, quieras programar una reunión, o estés listo para comprar, envíanos un mensaje breve a <a href="mailto:hola@karasolar.com">hola@karasolar.com</a>.',
    ...
    en: {
        ...
        'nextsteps-download-title': 'Download Results',
        'nextsteps-download-desc': 'Save your results and share them with friends and family.',
        'btn-download-results': 'Download Results',
        'nextsteps-catalogue-title': 'View Equipment Catalog',
        'nextsteps-catalogue-desc': 'Learn more about Kara Solar\'s solar transport systems: how it works, technical specifications, and after-sales service.',
        'btn-view-catalogue': 'View Catalog',
        'nextsteps-contact-title': 'Purchases and Inquiries',
        'nextsteps-contact-desc': 'Ready to make the transition to solar river transport? Whether you have questions, want to schedule a meeting, or are ready to buy, send us a quick message at <a href="mailto:hola@karasolar.com">hola@karasolar.com</a>.',
    ...
    pt: {
        ...
        'nextsteps-title': 'PRÓXIMOS PASSOS',
        'nextsteps-download-title': 'Baixar Resultados',
        'nextsteps-download-desc': 'Salve seus resultados e compartilhe com amigos e familiares.',
        'btn-download-results': 'Baixar Resultados',
        'nextsteps-catalogue-title': 'Ver Catálogo de Equipamentos',
        'nextsteps-catalogue-desc': 'Conheça mais sobre os sistemas de transporte solar da Kara Solar: como funciona, especificações técnicas e serviços pós-venda.',
        'btn-view-catalogue': 'Ver Catálogo',
        'nextsteps-contact-title': 'Compras e Consultas',
        'nextsteps-contact-desc': 'Pronto para fazer a transição para o transporte fluvial solar? Seja para tirar dúvidas, agendar uma reunião ou comprar, envie-nos uma mensagem em <a href="mailto:hola@karasolar.com">hola@karasolar.com</a>.',
        'btn-contact': 'Fale Conosco',
